...
def generate_character_script(params: CharacterParams) -> str:
    ...
    script_lines = [
        ...
        "",
        "# 使用 MPFB2 HumanService API 创建角色（headless 兼容）",
        "character_obj = None",
        "use_mpfb = False",
        "try:",
        ...
        '    print("MPFB2 未安装，将使用几何体降级: " + str(e))',
        "",
        "if use_mpfb:",
        "    try:",
        ...
        "            rig = RigService.add_default_rig(basemesh)",
        '            print("骨骼已添加")',
        "        except Exception as e:",
        '            print("骨骼添加跳过: " + str(e))',
        "",
        "    except Exception as e:",
        '    print("MPFB2 生成失败，降级到几何体: " + str(e))',
        "    use_mpfb = False",
        "",
